...
public class SecondActivity extends Activity implements ActionBar.TabListener {
    ...
    public static class Fragment_Zero extends Fragment {
        /**
         * The fragment argument representing the section number for this
         * fragment.
         */
    ...
    public static class Fragment_One extends Fragment {
        /**
         * The fragment argument representing the section number for this
         * fragment.
         */
    ...
    public static class Fragment_Two extends Fragment {
        /**
         * The fragment argument representing the section number for this
         * fragment.
         */
